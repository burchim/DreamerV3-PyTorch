...
class Manipulator(dm_control.DeepMindControlEnv):
    ...
    def __init__(self, task="bring_ball", img_size=(84, 84), mode="classic", history_frames=4, episode_saving_path=None, action_repeat=1):
        assert task in ["bring_ball"]
        super(Manipulator, self).__init__(domain="manipulator", task=task, img_size=img_size, mode=mode, history_frames=history_frames, episode_saving_path=episode_saving_path, action_repeat=1)
