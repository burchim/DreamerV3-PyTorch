...
class Cheetah(dm_control.DeepMindControlEnv):
    ...
    def __init__(self, task="run", img_size=(84, 84), mode="classic", history_frames=4, episode_saving_path=None, action_repeat=1):
        assert task in ["run"]
        super(Cheetah, self).__init__(domain="cheetah", task=task, img_size=img_size, mode=mode, history_frames=history_frames, episode_saving_path=episode_saving_path, action_repeat=action_repeat)
