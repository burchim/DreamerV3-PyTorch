...
def main(rank, args):
    ...
    assert args.mode in ["training", "evaluation", "pass"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--config_file",          type=str,   default="configs/DreamerV3/dreamer_v3.py",                          help="Python configuration file containing model hyperparameters")
    ...
    parser.add_argument("--verbose_progress_bar",       type=int,   default=2,                                                          help="Verbose level of progress bar display")
